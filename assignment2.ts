...
let multiply = (a: number, b: number = 1) => a * b;
...
let multiplyNoLimit = (...numbers: any[]) => (numbers.reduce((num, ind) => num * ind));
...
let printInformation = (name: String, mail?: String) => mail ? `tôi là ${name}. Email của tối là ${mail}` : `tôi là ${name}. Tôi chưa có Email`
